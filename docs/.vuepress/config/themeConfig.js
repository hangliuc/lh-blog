...
module.exports = {
  ...
  repo: "hangliuc/lh-blog", // 导航栏右侧生成Github链接
  ...
  author: {
    ...
    name: "hangliuc", // 必需
    link: "https://github.com/hangliuc", // 可选的
  },
  social: {
    // 社交图标，显示于博主信息栏和页脚栏
    ...
    icons: [
      {
        ...
        title: "GitHub",
        link: "https://github.com/hangliuc",
      },
      {
        iconClass: "icon-youjian",
        title: "发邮件",
        link: "mailto:iliuhang@163.com",
      },
      // {
  ...
  footer: {
    ...
    copyrightInfo:
      'Eryajf | <a href="https://github.com/hangliuc/lh-blog/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
  },
};
